...
def writeBlockMesh(templateLoc, fullCaseSetupDict):
    ...
    whcty = fullCaseSetupDict['BC_SETUP']['REF_COR'][1] #symmetry plane location
    whctz = fullCaseSetupDict['BC_SETUP']['REF_COR'][2] #wheel contact patch intersection with ground
